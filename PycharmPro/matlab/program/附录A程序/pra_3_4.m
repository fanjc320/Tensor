...
PT=T1(ix1:ix2);
ixd=ix2-ix1+1;
plot(XL+1:XL+ixd,PT,'k','linewidth',3);
line([1:XL+1],[Pm(1:XL) PT(1)],'color',[.6 .6 .6],'linewidth',3);
title(['第' num2str(k) '个元音主体与后向延伸基音周期曲线']);
ylim([0 50]); grid; ylabel('基音周期'); xlabel('样点数');
legend('元音主体基音周期','前向延伸基音周期',2);
fprintf('vsegch=%4d   vsegchlong=%4d\n',vsegch,vsegchlong);
